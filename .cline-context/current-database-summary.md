...
**Columns:**
- `id` (UUID, Primary Key)
- `user_profile_id` (UUID, Foreign Key → `profiles`)
- `name` (Text)
- `contact_name` (Text, Nullable)
- `contact_email` (Text, Nullable)
- `contact_number` (Text, Nullable)
- `location` (Text, Nullable)
- `agent_profile_id` (UUID, Foreign Key → `profiles`, Nullable)
- `commission_group_id` (UUID, Foreign Key → `commission_groups`, Nullable)
- `balance` (Numeric)
...
**Columns:**
- `id` (UUID, Primary Key)
- `retailer_id` (UUID, Foreign Key → `retailers`)
- `name` (Text)
- `auth_user_id` (UUID, Foreign Key → `profiles`, Nullable)
- `cashier_profile_id` (UUID, Foreign Key → `profiles`, Nullable)
...
**Columns:**
- `id` (UUID, Primary Key)
- `voucher_type_id` (UUID, Foreign Key → `voucher_types`)
- `amount` (Numeric)
- `pin` (Text)
...
**Columns:**
- `id` (UUID, Primary Key)
- `terminal_id` (UUID, Foreign Key → `terminals`, Nullable)
- `voucher_inventory_id` (UUID, Foreign Key → `voucher_inventory`)
- `sale_amount` (Numeric)
...
- `retailer_id` (UUID, Foreign Key → `retailers`, Nullable)
- `agent_profile_id` (UUID, Foreign Key → `profiles`, Nullable)
- `sale_id` (UUID, Foreign Key → `sales`, Nullable)
- `notes` (Text, Nullable)
- `created_at` (Timestamp)
...
**Columns:**
- `id` (UUID, Primary Key)
- `commission_group_id` (UUID, Foreign Key → `commission_groups`)
- `voucher_type_id` (UUID, Foreign Key → `voucher_types`)
...
**Columns:**
- `id` (UUID, Primary Key)
- `voucher_type_id` (UUID, Foreign Key → `voucher_types`, Nullable)
- `commission_group_id` (UUID, Foreign Key → `commission_groups`, Nullable)
- `amount` (Numeric)
...
**Columns:**
- `id` (UUID, Primary Key)
- `profile_id` (UUID, Foreign Key → `profiles`, Nullable)
- `bank_name` (Text)
- `account_holder` (Text)
- `account_number` (Text)
...
**Purpose:** Manage file storage and bucket information.  
Tracks:
- Uploaded objects  
- Multipart uploads  
...
- `Retailers`, `Terminals`, `Sales`, and `Transactions` are interconnected
